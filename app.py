...
if not visible:
    ...
    a, b = st.columns(2)
    a.page_link("pages/39_✍️_Historia_4_Estilos.py", label="📖 Criar Story Book", use_container_width=True)
...
with q1:
    card("Criar um livro", "Escolha a faixa etária, parta de uma ideia sua ou da IA e compare quatro estilos antes de ilustrar.", "pages/39_✍️_Historia_4_Estilos.py", "Criar →", "📖")
...
# ------------------------- catálogo avançado
advanced_routes = [
    ("✨ História em 4 Estilos", "pages/39_✍️_Historia_4_Estilos.py"),
    ("🪄 Prompt-Mestre Studio", "pages/38_🪄_Prompt_Mestre_Studio.py"),
