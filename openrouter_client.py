...
def chamar_llm(sistema: str, instrucao: str) -> dict | list:
    ...
    Importante: quando o Gemini não está disponível, este método chama
    _chamar_llm_openrouter() incondicionalmente — exatamente como o código
    original fazia — em vez de verificar OPENROUTER_API_KEY antecipadamente.
    Isso preserva o comportamento e as mensagens de erro de sempre (incluindo
    para testes que simulam falhas de rede/interrupção do Streamlit).
    """
